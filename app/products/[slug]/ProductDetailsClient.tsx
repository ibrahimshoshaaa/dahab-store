...
export default function ProductDetailsClient({
  ...
  useEffect(() => {
    ...
    async function loadProduct() {
      ...
      // Keep the client fallback so navigation remains resilient if data changes.
      const result = initialProduct || await fetchProductBySlug(slug)
      if (!active) return
